...
- save it in the *Kookaberry Scripts / KookaIDE* folder (or a sub-folder) on your desktop computer. Then use the **KookaCode** or **KookaIDE** programming tool to open it and click on the Run button to cause it to run on a USB-tethered Kookaberry.
