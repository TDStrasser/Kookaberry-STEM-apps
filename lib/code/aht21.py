...
class AHT21:
    ...
    Source: https://github.com/TimHanewich/Air-Quality-IoT/blob/master/src/AHT21.py
    - amended 19 April 2026 to correct some minor problems and adapted for use by the Kookaberry - T.Strasser, the AustSTEM Foundation
    ...
    def __init__(self, i2c:machine.I2C, address = 0x38): # The AHT21 I2C address is fixed at 0x38
        """
