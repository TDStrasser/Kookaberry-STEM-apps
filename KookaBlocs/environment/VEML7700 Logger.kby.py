...
i2c_P3AP3B = SoftI2C(scl="P3A", sda="P3B")
veml7700_i2c_P3AP3B = VEML7700(i2c=i2c_P3AP3B)
...
while True:
    if time.ticks_diff(time.ticks_ms(), _timer5000) >= 0:
        ...
        data_to_log = ["{:5.1f}".format(veml7700_i2c_P3AP3B.read_lux())]
        with open("data.csv", "at") as f:
