# Kookaberry KookaBlocs STEM Apps
This repository contains pre-coded STEM apps, written using the KookaBlocs / KookaBlockly visual MicroPython programming tool for the Kookaberry micro-computer.
To use an app, download it from one of the folders in the repository, and then either:
- save it in the *Kookaberry Scripts / KookaBlockly* folder (or a sub-folder) on your desktop computer. Then use the **KookaBlocs / KookaBlockly** programming tool to open it and click on the Run button to cause it to run on a USB-tethered Kookaberry.
